...
<div class="login-page">
  <div class="form">
    ...
    <form class="register-form" action="action.php" method="POST">
      ...
      <input type="text" placeholder="user/admin"name="usertype"/>
      <input type="password" placeholder="password 
      "name="password"/>
      <input type="text" placeholder="email address"name="email"/>
      <button type="submit"name= "register">create</button>
      <p class="message">Already registered? <a href="#">Sign In</a></p>
      <a href="login.php">BACK TO LOCATION</a>
...
body {
  ...
  background: rgb(60,200,800);
  background: linear-gradient(90deg, rgba(200,404,501) 0%, rgba(118,40,82,) 50%);
  font-family: "Roboto", sans-serif;
